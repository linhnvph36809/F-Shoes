...
import VariantComponent from '../../UpdateVariant/VariantComponent';

const FormUpdateProduct = ({ onFinish, images, setImages, initialValues, loading }: any) => {
    ...
    useEffect(() => {
        form.setFieldsValue({
            ...
            stock_qty: initialValues?.stock_qty,
        });
    }, [initialValues]);
