        ...
        <div className="space-y-4">
          ...
          <div
            className={`border rounded-lg shadow-sm ${
              openSections[0] ? "bg-blue-50" : "bg-white"
            }`}
          >
            <div
            ...
            {openSections[0] && (
              <div className="p-4 text-gray-600">
                Chính sách này nhằm đảm bảo mọi người tuân thủ các quy định và
                hành xử đúng mực trong môi trường làm việc/chung.
              </div>
            )}
          </div>
          ...
          <div
            className={`border rounded-lg shadow-sm ${
              openSections[1] ? "bg-blue-50" : "bg-white"
            }`}
          >
            <div
              className="flex justify-between items-center p-4 cursor-pointer"
...
<div
className={`border rounded-lg shadow-sm ${
              openSections[2] ? "bg-blue-50" : "bg-white"
            }`}
          >
            <div
              className="flex justify-between items-center p-4 cursor-pointer"
            ...
            {openSections[2] && (
              <div className="p-4 text-gray-600">
                Những hành vi vi phạm sẽ được xử lý theo quy định, tùy theo mức
                độ và tính chất của sự việc.
              </div>
            )}
          </div>
          ...
          <div
            className={`border rounded-lg shadow-sm ${
              openSections[3] ? "bg-blue-50" : "bg-white"
            }`}
          >
            <div
              className="flex justify-between items-center p-4 cursor-pointer"
            ...
            {openSections[3] && (
              <div className="p-4 text-gray-600">
                ...
                <span className="font-medium text-blue-600">01/01/2025</span> và
                được áp dụng đến khi có thông báo mới.
              </div>
            )}
          </div>
        </div>
