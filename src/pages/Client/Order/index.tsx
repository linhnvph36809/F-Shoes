    ...
    const onFinish = (value: any) => {
        ...
        if (value.payment_method == 'cash on delivery') {
            ...
            postVNPAY(value.payment_method, {
                ...
                url: 'http://localhost:5173/order-complete',
            });
        }
    };
                            ...
                            <div style={{ width: '100%', maxWidth: '800px' }}>
                                <Card bordered={false}>
                                    ...
                                    <div style={{ margin: '16px 0', fontSize: '12px' }}>
                                        <Text className="color-primary font-medium">
                                            Add 1,331,000₫ more to earn Free Shipping!
                                        </Text>
                                        <Progress
                                            percent={50}
                                            showInfo={false}
                                        ...
                                        <div className="flex gap-x-10" key={cart.id}>
                                            ...
                                            <div>
                                                <Title level={5} style={{ marginBottom: '8px' }}>
                                                    {cart?.product ? cart?.product.name : cart?.product_variation?.name}
                                                </Title>
                                                <div style={{ marginTop: '8px' }}>
                                                    <Text className="block">Qty: {cart?.quantity}</Text>
                                                    <Text className="block mt-5 font-medium text-[16px] color-primary">
                                                        Price:
                                                        {formatPrice(
                                                            cart?.product
                                                                ? cart?.product.price
