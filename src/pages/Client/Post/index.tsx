...
const Header = () => (
  ...
  <nav className="flex space-x-8 text-gray-300 flex-grow">
    <a href="#" className="hover:text-white text-16px">All</a>
    <a href="#" className="hover:text-white text-16px">Press Releases</a>
    <a href="#" className="hover:text-white text-16px">Collections</a>
  </nav>

  {/* Input tìm kiếm */}
  <div className="flex items-center ml-auto "> {/* Thêm khoảng cách bên phải */}
    <Input
      placeholder="Search"
