...
const OrderItem: React.FC<Props> = ({ product, variation, quantity }) => {
    return (
        <Link
            ...
            className="opacity-80 bg-gray-50 cursor-pointer hover:opacity-100 hover:bg-white h-[100%] py-4 flex items-center border-2 rounded-xl space-x-4 relative p-2"
        >
            ...
            <div className="flex flex-col text-2xl space-y-4  max-w-[50%]">
                ...
                <div className="truncate-100 ">
                    <span className="color-gray">Quantity:</span>x{quantity}
                </div>
            </div>
