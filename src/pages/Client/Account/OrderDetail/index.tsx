    ...
    const handlePaymentAgain = (payment: 'vnpay' | 'momo' | 'cash_on_delivery') => {
        switch (payment) {
            ...
            case 'cash_on_delivery':
                ...
                break;
            default:
                showMessageClient('Error!', '', 'warning');
                break;
        }
    };
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <div className="flex items-center gap-x-2">
                                        <p className="text-[16px] color-gray font-medium">
                                ...
                                <div className="flex gap-x-10">
                                    <div className="w-6/12">
                                        <h3 className="text-[16px] color-gray my-3">
                                        ...
                                        <p className="text-[16px] color-gray my-3">
                                            <span className="font-medium">
                                                {' '}
                                        ...
                                        <p className="text-[16px] color-gray mb-3">
                                            <span className="font-medium">
                                                {' '}
                                    ...
                                    <div className="w-6/12 pl-10 border-l">
                                        <div className="flex items-center justify-between pb-5 mb-5 border-b text-[16px] color-gray">
                                            <p>
                                                {' '}
                                                <p>
                                        ...
                                        {order?.reason_cancelled ? (
                                            <div className="flex justify-between pb-5 items-center mb-5 border-b text-[16px] color-gray">
                                                ...
                                                <p className="font-medium text-red-500">{order?.reason_cancelled}</p>
                                            </div>
                                        ) : (
                                            ''
                                        )}
                                            ...
                                            {order?.status === 1 && currentTime < givenTimePlusOneHour ? (
                                                <div>
                                                    <div className="flex items-center gap-x-5">
                                                        <div
                                                            onClick={() => handlePaymentAgain('momo')}
                                                            ...
                                                            {loading && loadingPaymentOn === 'momo' ? (
                                                                ...
                                                                <>
                                                                    <img
                                                                        ...
                                                                        className={'w-[30px]'}
                                                                    />
                                                                    <div className="text-[18px] font-medium color-gray">
                                                                        Momo
                                                                    </div>
                                                                </>
                                                            )}
                                                        ...
                                                        <div
                                                            onClick={() => handlePaymentAgain('vnpay')}
                                                            className="w-[150px] h-[50px] flex gap-x-5 items-center justify-center p-5 bg-white border
                                                        ...
                                                        <div
                                                            onClick={() => handlePaymentAgain('cash_on_delivery')}
                                                            className="w-[300px] h-[50px] flex gap-x-5 items-center justify-center p-5 bg-white border
                                                        rounded-xl hover:cursor-pointer transition-global hover:opacity-70"
                                                        >
                                                            {loadingPutOrder ? (
                                                                <LoadingSmall color="color-primary" />
