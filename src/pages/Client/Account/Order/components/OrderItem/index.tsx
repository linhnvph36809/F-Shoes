...
const OrderItem = ({ order }: { order: IOrder }) => {
    ...
    return (
        <div
            className="grid grid-cols-6 items-center px-10 h-[100px] bg-whitesmoke
        rounded-xl mb-8 gap-x-10"
        >
            <div>
            ...
            <div>
                <Link to="/">
                    <button
                        className="w-[150px] h-[50px] text-[15px] font-medium color-primary border border-[#111111] rounded-[50px] 
