...
const Header = () => {
    return (
      <div className="bg-black text-white p-6 py-16"> {/* Giảm padding dọc */}
        <div className="flex flex-col lg:flex-row gap-6">
          {/* Cột bên trái */}
          <div className="lg:w-1/3 flex flex-col mt-auto"> {/* Thêm mt-auto nếu cần */}
                <h1 className="text-white text-15px">31 tháng 10, 2024</h1>
                <div> {/* Không thêm margin-top để phần Share sát với ngày tháng */}
                    <h1 className="text-white text-15px cursor-pointer">Share</h1>
            </div>
        </div>  
          {/* Cột bên phải */}
          <div className="lg:w-2/3">
            <div className="flex gap-4 mb-4">
              <span className="bg-gray-700 px-4 py-2 rounded-full text-lg cursor-pointer">Newsroom</span>
              <span className="bg-gray-700 px-4 py-2 rounded-full text-lg cursor-pointer">Purpose</span>
            </div>
            {/* Tiêu đề */}
